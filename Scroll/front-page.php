...
?>
	...
	<div class="loader-container">
			<div class="spinner">
				...
				<h4>For the best results please let all images load.</h4>
				<p> Need to do something about that</p>
			</div>
			<div class="center">
		...
		<div class="container scroll-container">
			<section class="scroll-sequence__container sunrise-container">
					<span class="scrolling-label">Just start scrolling</span>
				<div class="scroll-sequence sunrise-sequence"></div>
				<div class="scroll-sequence__content">
					<div class="talking-points speak-sunset">
						<h1>Ernies High</h1>
						<p>This custom WordPress theme's homepage uses a scrolling animation. It is createed with plain JavaScript and CSS. </p> 
					</div>
					<div class="talking-points speak-sunset">
						<h1>A custom WordPress theme</h1>
					<p>Ernies High building custom WordPress themes and sites for over 10 years.</p>
					 
					</div>
					<div class="talking-points speak-sunset">
						<h1>Providing custom functionality and styling</h1>
						<p>Using PHP, JavaScript, jQuery, HTML, CSS, MySQL and related frameworks,</p>
					</div>
				</div>
			</section>
	 <div class="spacer green">Keep on scrolling</div>
			<section class="scroll-sequence__container sprout-container">
				<div class="scroll-sequence sprout-sequence"></div>
				<div class="scroll-sequence__content">
					<div class="talking-points sprout-sunset">
						<h1>Over 10 years experience</h1>
						<p>Working as a freelance web developer Ernies High is skilled in both frontend and backend coding.</p>
						<p>Creating custom functionality and styling using PHP, JavaScript/jQuery, HTML, CSS, MySQL and related frameworks</p>
					</div>
					
					<div class="talking-points sprout-sunset">
						<h1>Credits</h1>
						<p>The scrolling function is borrowed from <a href="https://codepen.io/jacob_124/pen/dyydWbB" target="_blank">A codepen by Jacob</a>. It is modifed to meet my needs and wants.</p>
						<p> The images are taken from a video on Adobe Stock. Then saved as JPG's using Photoshop. </p>
					</div> 
					
					<div class="talking-points sprout-sunset">
						<h1>To see a few examples</h1>
						<p><a href="/sample/" class="button"> Check out Ernies High</a></p>
					</div>
				</div>
			</section>
		</div>
	...
	const sunSequenceImages = [];
	const sproutSequenceImages = [];

	for (let i = 0; i <= 300; i ++) {
	  sunSequenceImages.push(`${`000${i}`.slice(-3)}.jpg`);
	}
	for (let i = 0; i <= 420; i ++) {
	  sproutSequenceImages.push(`${`000${i}`.slice(-3)}.jpg`);
	}
...
const sunSequence = new ScrollSequence({
  container: '.sunrise-sequence',
  scrollWith: '.sunrise-container',
  images: sunSequenceImages,
  imagesRoot: './wp-content/themes/the-high/assets/images/sun/',
...
console.log(sunSequence)

const sproutSequence = new ScrollSequence({
  container: '.sprout-sequence',
  scrollWith: '.sprout-container',
  images: sproutSequenceImages,
  imagesRoot: './wp-content/themes/the-high/assets/images/sprout/',
  priorityFrames: [0, 20, 40, 60, 90],
  cover: true,
  starts: 'out',
  ends: 'in'
